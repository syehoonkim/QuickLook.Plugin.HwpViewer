...
- **rhwp**  
  Copyright © **Edward Kim**
  **MIT License**에 따라 라이선스됨  
...
This plugin was developed on top of [**hwp.js**](https://github.com/hahnlee/hwp.js), but currently is developed on top of [**rhwp**](https://github.com/edwardkim/rhwp).
